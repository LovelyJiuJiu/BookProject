...
<!-- 				<li class="layui-nav-item">
					<a onclick="hideOtherAndShowIt('bookMain'); return true;" href="admin/bookMainPage" target="bookMain">主页管理</a></li> -->
...
<!-- 		<iframe class="hideIframs" id="bookMain" name="bookMain" frameborder="0"></iframe>  --> 
